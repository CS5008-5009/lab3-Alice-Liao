...
int main(){
    ...
    printf("delete 7 from the middle of the linked list.\n");
    deleteMiddle(slist, 7);
    printNode(slist->head);
    printf("Insert 7 at the front of the linked list.\n");
    insertFront(slist, 7);
    printNode(slist->head);
    printf("delete 7 from the front of the linked list.\n");
    deleteFront(slist);
    printNode(slist->head);
    printf("Insert 7 at the end of the linked list.\n");
    insertEnd(slist, 7);
    printNode(slist->head);
    printf("delete 7 at the end the linked list.\n");
    deleteEnd(slist);
    printNode(slist->head);
